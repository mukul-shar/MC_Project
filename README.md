...
_See *addRoomIdOnSpinner()* to update list of rooms in spinner.

_See *addFacultyIdOnSpinner()* to update list of faculties in spinner.

_See *onClick()* to fetch input data.
